...
func TestQueryBaseJobRunTestStatus_AggregateFallback(t *testing.T) {
	t.Run("prefix-sum fallback when per-run data is absent", func(t *testing.T) {
		...
		test := createTest(t, dbc, "openshift-tests:[sig-storage] agg fallback test")
		suite := createSuite(t, dbc, "openshift-tests-agg")
	...
	t.Run("GA fallback when per-run data is absent", func(t *testing.T) {
		...
		test := createTest(t, dbc, "openshift-tests:[sig-storage] GA agg fallback test")
		suite := createSuite(t, dbc, "openshift-tests-ga-agg")
	...
	t.Run("per-run data takes precedence over aggregate", func(t *testing.T) {
		...
		test := createTest(t, dbc, "openshift-tests:[sig-storage] precedence test")
		suite := createSuite(t, dbc, "openshift-tests-prec")
	...
	t.Run("variant filtering applied in fallback", func(t *testing.T) {
		...
		test := createTest(t, dbc, "openshift-tests:[sig-storage] variant filter test")
		suite := createSuite(t, dbc, "openshift-tests-vf")
	...
	t.Run("RequestedVariants filtering applied in fallback", func(t *testing.T) {
		...
		test := createTest(t, dbc, "openshift-tests:[sig-storage] requested variants test")
		suite := createSuite(t, dbc, "openshift-tests-rv")
	...
	t.Run("multiple jobs aggregated separately", func(t *testing.T) {
		...
		test := createTest(t, dbc, "openshift-tests:[sig-storage] multi job test")
		suite := createSuite(t, dbc, "openshift-tests-mj")
	...
	t.Run("aggregate fallback rows have no individual run data", func(t *testing.T) {
		...
		test := createTest(t, dbc, "openshift-tests:[sig-storage] aggregate no-run-id test")
		suite := createSuite(t, dbc, "openshift-tests-flag")
	...
	t.Run("per-run rows have individual run data", func(t *testing.T) {
		...
		test := createTest(t, dbc, "openshift-tests:[sig-storage] per-run has-run-id test")
		suite := createSuite(t, dbc, "openshift-tests-notflag")
	...
	t.Run("zero-delta rows excluded by HAVING filter", func(t *testing.T) {
		...
		test := createTest(t, dbc, "openshift-tests:[sig-storage] having filter test")
		suite := createSuite(t, dbc, "openshift-tests-having")
	...
	t.Run("test metadata populated in fallback results", func(t *testing.T) {
		...
		test := createTest(t, dbc, "openshift-tests:[sig-storage] metadata fallback test")
		suite := createSuite(t, dbc, "openshift-tests-meta")
...
func TestTestDetailStatusMapping(t *testing.T) {
	...
	summary := summaries[0]
	assert.Equal(t, 3, summary.Stats.Total(), "should have 3 total runs")
...
func testDetailsReqOptions(release, testID string, variants map[string]string) reqopts.RequestOptions {
	opts := defaultReqOptions(release)
	opts.TestIDOptions = []reqopts.TestIdentification{{
		TestID:            testID,
...
func TestTestDetailsReport_AggregateBaseStats(t *testing.T) {
	...
	test := createTest(t, dbc, "openshift-tests:[sig-storage] aggregate base stats test")
	suite := createSuite(t, dbc, "openshift-tests-td-agg")
	...
	variants := map[string]string{"Platform": "aws", "Network": "ovn"}
	opts := testDetailsReqOptions(release, tow.UniqueID, variants)
...
func TestTestDetailsReport_LastFailureTracking(t *testing.T) {
	t.Run("last failure populated from sample failures", func(t *testing.T) {
		...
		test := createTest(t, dbc, "openshift-tests:[sig-storage] last failure tracking test")
		suite := createSuite(t, dbc, "openshift-tests-td-lf")
	...
	t.Run("last failure nil when all sample runs pass", func(t *testing.T) {
		...
		test := createTest(t, dbc, "openshift-tests:[sig-storage] last failure nil test")
		suite := createSuite(t, dbc, "openshift-tests-td-lf-pass")
...
func TestTestDetailsReport_FlakeAsFailure(t *testing.T) {
	...
	test := createTest(t, dbc, "openshift-tests:[sig-storage] flake as failure test")
	suite := createSuite(t, dbc, "openshift-tests-td-faf")
	...
	optsFalse := testDetailsReqOptions(release, tow.UniqueID, variants)
	...
	optsTrue := testDetailsReqOptions(release, tow.UniqueID, variants)
